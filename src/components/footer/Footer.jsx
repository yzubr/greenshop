...
export default function footer() {
  return (
    <footer className={styles.footer}>
      ...
      <section>
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>Plant Care Basics</li>
              <li>Soil Selection</li>
              <li>Watering Techniques</li>
              <li>Pest Control</li>
              <li>Seasonal Gardening</li>
            </ul>
          </li>
          <li>
            <h3>Social Media</h3>
      ...
      <section className={styles['mobile-footer']}>
        <details name="faq">
        ...
        <details name="faq">
          <summary>Gardening Tips</summary>
          <p>Plant Care Basics</p>
          <p>Soil Selection</p>
          <p>Watering Techniques</p>
          <p>Pest Control</p>
          <p>Seasonal Gardening</p>
        </details>
        <ul className={styles['social-media-block']}>
          <li>
            <a href="http://instagram.com">
